...
export const projects: Project[] = [
	...
	},
	{
		...
		keyPoints: [
			"Developed Fitness Match using <span>ReactJS, NodeJS, ExpressJS, MongoDB,</span> and <span>RESTfull APIs.</span>",
...
export const contributions: Contribution[] = [
	...
	{
		prTitle:
			"feature: Autoplay the next video after completion of one and Add next and prev button in video-js comp #1308 #1434",
...
export const publications: Publication[] = [
	{
		...
		blogLink:
			"https://medium.com/@19bcs1922/server-side-rendering-ssr-vs-static-site-generation-ssg-choosing-the-right-approach-in-next-js-cf2ec5eb58e4",
		blogCover:
			"https://miro.medium.com/v2/resize:fit:828/format:webp/1*jZCYevnotN_5UKCsX0I1fw.jpeg",
		blogDescription:
